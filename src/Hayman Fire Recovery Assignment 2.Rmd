...
#correlation preburn
cor_preburn<-cor(combinedPRE$mean_PREBURNNDSI, combinedPRE$mean_PREBURNNDVI)

#plot for combined preburn
plot1<-ggplot(combinedPRE, aes(x=mean_PREBURNNDSI, y=mean_PREBURNNDVI,color=site)) +
  geom_point(size=2)+ 
  labs(title = "Preburn", 
       x= "Mean Preburn NDSI
       y= Mean preburn NDVI") 
...
cor_postburn<-cor(combinedPOST$mean_postburnNDSI, combinedPOST$mean_postburnNDVI)

#plot for combined postburn
plot1<-ggplot(combinedPRE, aes(x=mean_postburnNDSI, y=mean_postburnNDVI,color=site)) +
  geom_point(size=2)+ 
  labs(title = "Postburn", 
...
Preburngraph<-ggplot(combinedPRE, aes(x=mean_PREBURNNDSI, y=mean_PREBURNNDVI)) +
  geom_point() + 
  theme_few() +
  scale_color_few() 

Postburngraph<-ggplot(combinedPRE, aes(x=mean_postburnNDSI, y=mean_postburnNDVI,color=site)) +
  geom_point() +
  theme_few() +
  scale_color_few() 
